<template>
  <!-- ⭐ CONTAINER GENERAL -->
  <div class="max-w-7xl mx-auto bg-white rounded-xl w-full py-6 px-2 sm:px-4">
    ...
    <div class="p-2 sm:p-4 w-full flex flex-col">
      <div class="flex flex-col sm:flex-row justify-between items-center mb-4 gap-3">
          ...
          <div class="flex w-full border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
            ...
            <input
              ...
              class="flex-1 p-2 text-sm sm:text-base bg-white dark:bg-gray-700
                     ...
                     dark:placeholder-gray-300 focus:outline-none"
            />
        ...
        <div class="flex gap-2">
          <button
            ...
            class="flex items-center justify-center gap-2 px-4 py-2 bg-[#102372]
                   hover:bg-[#e65500] text-white rounded-md font-medium transition"
          >
          ...
          <transition name="fade-scale">
            <button
              ...
              class="flex items-center justify-center gap-2 bg-red-600
                     hover:bg-red-700 text-white px-4 py-2 rounded-md transition"
            >
      ...
      <div
        class="flex flex-col sm:flex-row justify-between items-center mt-4 text-xs sm:text-sm
               text-gray-700 dark:text-gray-300 gap-2 bg-[#f3f3f3] dark:bg-gray-800
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <select
            ...
            class="border dark:border-gray-600 rounded px-2 py-1 text-xs sm:text-sm
